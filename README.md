...
### 2. Femicidios en Costa Rica 2007-2026
**Tools:** Python, Tableau, Figma
**Description:** Data storytelling dashboard on femicide cases in Costa Rica. Includes trend analysis, victim age distribution, and impact on children.
🔗 [View Dashboard](https://public.tableau.com/views/FemicidiosenCostaRica/Dashboard1)
...
[View Dashboard](https://public.tableau.com/views/PrivateCreditDirectLending-TheRiseofa1_7TMarket/Dashboard1?:language=es-ES&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
---
